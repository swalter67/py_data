...
def ft_load(path: str) -> np.ndarray:
    ...
    This function loads an image file from the specified path using the Python Imaging Library (PIL) and
    ...
    Raises:
        AssertionError: If the argument is not a string, if the file does not exist, or if the path is not a file.

    Prints:
        Information about the shape of the loaded image (height, width, and layers).
    ...
    Note:
        Make sure to install the required dependencies before using this function:
